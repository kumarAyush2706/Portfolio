    ...
    <section className="qualification section " id="qualification">
      ...
      <div className="qualification_container container">
        <div className="qualification_tabs">
            <div className={toggleState===1?"qualification_active button--flex":"qualification_button button--flex"}
            onClick={()=>toggleTab(1)}
            >
                <i className="uil uil-graduation-cap qualification_icon"></i>Education
            </div>
            <div className={toggleState===2?"qualification_active button--flex":"qualification_button button--flex"} 
            onClick={() => toggleTab(2)}>
        ...
        <div className="qualification_sections">
            <div className={
                ...
                <div>
                    ...
                    <div>
                        <h3 className="qualification_title">Bachlor of Computer Application </h3>
                ...
                <div className="qualification_data">
                    ...
                    <div>
                        ...
                        <span className="qualification_subtitle">
                            ...
                            <div className="qualification_calender">
                                <i className="uil uil-calender"></i>20219 - 2021
                            </div>
                    </div>
                    <div>
                        <span className="qualification_rounder"></span>
                ...
                <div className="qualification_data">
                    ...
                    <div>
                        <h3 className="qualification_title"> Matricualtion</h3>
                        <span className="qualification_subtitle">
                            Science stream   
                            </span>
                            <div className="qualification_calender">
